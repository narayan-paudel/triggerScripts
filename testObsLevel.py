...
#   submitFile.write("Executable = /home/enpaudel/icecube/triggerStudy/triggerScripts/testObsLevel.sh\n")
...
def submitToCondorFile(corsikaFile,primary):
  ...
  subprocess.call(["/home/enpaudel/icecube/triggerStudy/triggerScripts/testObsLevel.sh {}".format(corsikaFile)], shell=True)
