...
# rm $OUTPUT_FOLDER/temp/$CORSIKA_ID $OUTPUT_FOLDER/ITGen/${CORSIKA_ID}GenDetFilt.i3.bz2 $OUTPUT_FOLDER/ITGen/${CORSIKA_ID}GenDet.i3.bz2 $OUTPUT_FOLDER/ITGen/${CORSIKA_ID}Gen.i3.bz2
