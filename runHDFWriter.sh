...
PYTHON_SCRIPT=$BASEDIR/hdfWriter.py
...
fileDir="/home/enpaudel/icecube/triggerStudy/simFiles/trigChkTestSeparate/"
fileList=$(ls -d $fileDir/DAT*GenDetFiltProcTrigCount.i3.gz)
