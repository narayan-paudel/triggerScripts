...
class Hoerandel5(Hoerandel):
	...
	"""
	ptypes = [int(getattr(ParticleType, p)) for p in ('PPlus', 'He4Nucleus', 'N14Nucleus', 'Al27Nucleus', 'Fe56Nucleus')]
	def __init__(self):
...
class Hoerandel_IT(Hoerandel):
	...
	"""
	ptypes = [int(getattr(ParticleType, p)) for p in ('PPlus', 'He4Nucleus', 'O16Nucleus', 'Fe56Nucleus')]
	def __init__(self):
