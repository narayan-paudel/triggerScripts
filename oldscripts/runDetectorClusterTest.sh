...
I3BUILD=/home/enpaudel/icecube/surfaceArray/buildTest/
I3SRC=/home/enpaudel/icecube/surfaceArray/srcTest/
...
OUTPUT_FOLDER1=/home/enpaudel/icecube/triggerStudy/simFiles/
start_time=$SECONDS
...
FLAGS2+=" --inputfile $OUTPUT_FOLDER1/dataSet/${PRIMARY_NAME}${CORSIKA_ID}Gen.i3.bz2"
