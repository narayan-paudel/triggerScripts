...
def BaseProcessing(tray, name, pulses='MuonPulseSeriesReco',
     ...
     tray.AddModule('I3TopHLCClusterCleaning', name + '_' + filter_globals.IceTopSplitter,
                     ...
                     InputPulses               = 'IceTopHLCVEMPulses',
     ...
     tray.AddModule('I3HLCTankPulseMerger', 'IceTopTankPulseMerger_HLC',
                     InputVEMPulses   = filter_globals.CleanedHLCTankPulses,
     ...
     tray.AddModule('I3HLCTankPulseMerger', 'IceTopTankPulseMerger_SLC',
