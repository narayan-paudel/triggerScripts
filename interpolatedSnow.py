...
snowFile2023 = "/home/enpaudel/icecube/triggerStudy/snowHeight/SnowSurvey-Nov2023.ods"
snow23_df = pd.read_csv(snowFile2023,skiprows=lambda x: x in np.arange(150,200),encoding='latin-1')
# snow23_df = np.genfromtxt(snowFile2023,delimiter=",")
...
def tankLayout(x,y,stations,r):
  ...
  plt.savefig(plotFolder+"InterpolatedSnowtankLayout{:d}.pdf".format(r),transparent=False,bbox_inches='tight')
  plt.close()

def getSnowHeight2023(filePath):
  pass


tankLayout(x,y,stations,640)
# tankLayout(x,y,stations,410)
