...
# def addCleanHLCVemPulses(frame):
# 	if frame.Has("OfflineIceTopHLCVEMPulses"):
# 		psm = dataclasses.I3RecoPulseSeriesMap.from_frame(frame,"OfflineIceTopHLCVEMPulses")
# 		psmClean = dataclasses.I3RecoPulseSeriesMap()
# 		for omkey,pulses in psm:
# 			ps = dataclasses.I3RecoPulseSeries()
# 			cleanPulse = []
...
# 				psmClean[omkey] = dataclasses.I3RecoPulseSeries(sorted(ps,
#             key=lambda pulse: pulse.time))
# 		frame["ITCleanHLCVEMPulses"] = psmClean

# tray.AddModule(addCleanHLCVemPulses,"cleanHLCVEM",
# 	streams=[icetray.I3Frame.DAQ])

# tray.AddModule('I3HLCTankPulseMerger',"hlcMerger",
# 	           InputVEMPulses = 'ITCleanHLCVEMPulses',
# 	           OutputTankPulses = 'ITCleanHLCTankPulses',
...
tray.AddModule("I3Writer","i3writer",
	          ...
	          filename=str(outputDir)+"/hadronTimeTest/"+str(fileName)+"CleanVEMEvts.i3.gz",
	          streams=[icetray.I3Frame.DAQ],
	          # streams=[icetray.I3Frame.DAQ,icetray.I3Frame.Physics],
	          # streams=[icetray.I3Frame.Geometry,icetray.I3Frame.Calibration, icetray.I3Frame.DetectorStatus]
	          )
